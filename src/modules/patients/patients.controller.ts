...
export class PatientsController {
  ...
  @ApiOperation({
    ...
    description:
      'Crea automáticamente un usuario del sistema usando los datos del paciente. La contraseña será su número de identificación.',
  })
  @ApiParam({
    name: 'id',
    description: 'ID del paciente',
  ...
  @ApiOperation({ summary: 'Obtener todos los cuestionarios de un paciente' })
  @ApiParam({
    name: 'id',
    description: 'ID del paciente',
    type: 'string',
  ...
  getPatientQuestionnaires(@Param('id') id: string) {
    return this.patientsService.getPatientQuestionnaires(id);
  }

  @Get(':patientId/questionnaires/:patientQuestionnaireId')
  @ApiOperation({
    summary:
      'Obtener preguntas y respuestas de un cuestionario específico de un paciente',
  })
  @ApiParam({
    name: 'patientId',
    description: 'ID del paciente',
  ...
  @ApiResponse({
    status: 200,
    description:
      'Detalle del cuestionario con preguntas y respuestas obtenido exitosamente',
  })
  @ApiResponse({
    status: 404,
  ...
  getPatientQuestionnaireDetails(
    ...
    @Param('patientQuestionnaireId') patientQuestionnaireId: string,
  ) {
    return this.patientsService.getPatientQuestionnaireDetails(
      patientId,
      patientQuestionnaireId,
    );
  }

  // === Clinical Information Endpoints ===
  @Patch(':id/clinical-info')
  @ApiOperation({
    summary: 'Update clinical information for a patient',
    description:
      'Update current illness and diagnostic plan fields (free text)',
  })
  @ApiParam({
    name: 'id',
  ...
  updateClinicalInfo(
    ...
    return this.patientsService.updateClinicalInfo(
      id,
      updateClinicalInfoDto.currentIllness,
      updateClinicalInfoDto.diagnosticPlan,
  ...
  @ApiOperation({
    ...
    description:
      'Retrieve current illness, diagnostic plan, and update information',
  })
  @ApiParam({
    name: 'id',
    description: 'Patient ID (CUID)',
  ...
  getClinicalInfo(@Param('id') id: string) {
