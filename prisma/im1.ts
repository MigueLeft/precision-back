...
export const scoringQuestions = [
  ...
  // A.6. Estatus Socioeconómico - im1_a6_1
  {
    ...
    descriptionText: 'Esta escalera representa la diferente posición socioeconómica de las personas en nuestra sociedad. En la parte superior de la escalera están las personas que tienen el mejor estatus social, son los que tienen más dinero y el mejor trabajo. En la parte inferior de la escalera están las personas que están en su peor momento, son lo que tienen menos dinero y los peores o ningún trabajo. Elija del 1 al 10, una posición en la escalera que crea que corresponde a su posición en la sociedad.',
...
export const nonScoringQuestions = [
  ...
  // A.3. Etnia-raza (1 question - im1_a3_1 removed)
  {
    code: 'im1_a3_2',
  ...
  // A.4. Idioma (1 question)
  {
    ...
    options: {
      choices: [
        ...
        { value: 'chino_mandarin', label: 'Chino (Mandarín)' },
        { value: 'chino_cantonés', label: 'Chino (Cantonés)' },
  ...
  // B.4. Embarazos y partos (7 questions — solo se muestran si género es femenino)
  {
    code: 'im1_b4_1',
  ...
  },
  {
    ...
    options: {
      choices: [
        ...
        { value: 'tenis_mesa', label: 'Tenis de mesa (Ping-pong)' },
        { value: 'rugby', label: 'Rugby' },
        { value: 'boxeo', label: 'Boxeo' },
        { value: 'golf', label: 'Golf' },
        { value: 'gimnasia', label: 'Gimnasia (Artística y rítmica)' },
        { value: 'futbol_americano', label: 'Fútbol americano' },
        { value: 'cricket', label: 'Críquet' },
        { value: 'hockey', label: 'Hockey (Sobre césped o hielo)' },
        { value: 'artes_marciales', label: 'Artes Marciales (Judo, Karate, Taekwondo, MMA)' },
        ...
        { value: 'polo_acuatico', label: 'Polo acuático' },
        { value: 'remo', label: 'Remo' },
        { value: 'esgrima', label: 'Esgrima' },
        { value: 'escalada', label: 'Escalada / Bouldering' },
  ...
  },
  {
    ...
    options: {
      choices: [
        { value: 'caminar', label: 'Caminar por ejercicio' },
        { value: 'correr', label: 'Correr / trotar' },
        { value: 'gimnasio', label: 'Gimnasio / pesas / máquinas' },
        { value: 'clases_dirigidas', label: 'Clases dirigidas (zumba, aeróbic, spinning, etc.)' },
        ...
        { value: 'patinaje_recreativo', label: 'Patinaje recreativo' },
