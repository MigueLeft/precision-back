...
exports.permissionsData = void 0;
...
async function seedPermissions(prisma, logger) {
    logger.log('🔐 Seeding Permissions...');
    try {
        for (const permission of exports.permissionsData) {
        ...
        logger.log(`🎉 Successfully created ${exports.permissionsData.length} permissions`);
