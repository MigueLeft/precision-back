...
exports.symptomsData = exports.symptomCategoriesData = void 0;
exports.seedSymptoms = seedSymptoms;
exports.symptomCategoriesData = [
    {
        name: 'cardiovascular',
...
async function seedSymptoms(prisma, logger) {
    logger.log('🔍 Seeding Symptoms...');
    try {
        logger.log('Creating symptom categories...');
        for (const category of exports.symptomCategoriesData) {
        ...
        let totalSymptoms = 0;
        for (const [categoryName, symptoms] of Object.entries(exports.symptomsData)) {
        ...
        logger.log(`   - ${exports.symptomCategoriesData.length} Symptom Categories`);
...
//# sourceMappingURL=symptoms-seeder.js.map